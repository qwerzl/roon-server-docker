...
qwerzl@localhost /o/c/r/roon-server> ls
Dockerfile  LICENSE  README.md  app  cache  data  docker-compose.yml  tailscale_var_lib
qwerzl@localhost /o/c/r/roon-server> ls data
Appliance  RoonDotnet  Server  VERSION  check.sh  start.sh
qwerzl@localhost /o/c/r/roon-server> ls app
entrypoint.sh
qwerzl@localhost /o/c/r/roon-server> nano app/entrypoint.sh
qwerzl@localhost /o/c/r/roon-server> nano Dockerfile
qwerzl@localhost /o/c/r/roon-server> cat Dockerfile
##################
## base stage
##################
FROM ubuntu:jammy AS BASE
